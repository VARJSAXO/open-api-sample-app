export default {
  ...
  getOrderData: (responseData) => { return {
  ...
  getPositionsData: (responseData) =>{ return {
          ...
          CurrentPrice:responseData.PositionView.CurrentPrice,
          ProfitLossOnTrade:responseData.PositionView.ProfitLossOnTrade,
          ProfitLossOnTradeInBaseCurrency:responseData.PositionView.ProfitLossOnTradeInBaseCurrency,
          TradeCostsTotal:responseData.PositionView.TradeCostsTotal,
          TradeCostsTotalInBaseCurrency:responseData.PositionView.TradeCostsTotalInBaseCurrency,
          Exposure:responseData.PositionView.Exposure,
          ExposureInBaseCurrency:responseData.PositionView.ExposureInBaseCurrency,
