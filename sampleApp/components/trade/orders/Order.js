...
import { Table, Button, ButtonToolbar, Form, FormGroup, FormControl, ControlLabel, Col, Row, Panel, Tabs, Tab } from 'react-bootstrap';
...
export default class Order extends React.Component {
    ...
    createOrderSubscription() {
        ...
        this.orderSubscription = API.createOrderSubscription(subscriptionArgs,this.OnOrderUpdate);
    ...
    onInstrumentChange(instrument){
            ...
            API.getInfoPrices(queryParams,this.onInfoPrice);
       }
